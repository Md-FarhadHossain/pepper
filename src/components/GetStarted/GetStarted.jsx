    ...
    <div data-aos="flip-up" data-aos-duration="2000">
      ...
      <div className="bg-[#151531] rounded-[2rem] relative lg:py-20 py-10 px-7">
        <div className="left-0 top-0 absolute">
          ...
          <img className="lg:hidden md:hidden block" src={gs5} alt="overview-cus-2" />
        </div>
        ...
        <div className="flex flex-col justify-center items-center text-center">
          ...
          <button className="btn btn-outline border-white lg:ml-5 md:ml-5 ml-0 mt-5 lg:mt-0 md:mt-0 normal-case text-[0.938rem] px-[2.043rem] py-3 rounded-2xl h-[3.55rem] text-white">Compare plans</button>
          </div>
        </div>
        ...
        <div className="absolute right-0 bottom-0">
          ...
          <img className="lg:hidden md:hidden block" src={gs6} alt="overview-cus-2" />
        </div>
      </div>
