...
const UpdateLogo = () => {
  const {logoImage, setLogoImage,logoUpload,setLogoUpload } = useContext(UserContext);
    ...
    <div className="w-full container mx-auto px-24 mt-16">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="text-end">
          {
            upload ? <button className="btn loading mt-4">loading</button> : <button type="submit" className="btn mt-4">Upload</button>
          }
          <button onClick={handleImageSave} className="btn mt-4 ml-4">Save</button>
        </div>
      </form>
